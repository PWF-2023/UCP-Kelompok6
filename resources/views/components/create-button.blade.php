...
<a href="{{ $href }}" {{ $attributes->merge(['class' => 'inline-flex item-center px-4 py-2
bg-gray-800 dark:ng-gray-200 border border-transparent rounded-md font-semibold text-xs text-white
